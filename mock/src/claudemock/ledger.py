...
WIDTH = 32
"""Where the numbers end. §21's block, whose columns are a golden string."""
...
"""Field name to printed label, in §21's order. One tuple rather than two dicts,
because the order is part of the block and a second list would be a second thing
to keep in step."""
