...
| `extract-skills (again)` | 2 | 2.4 | refused: the files are already there |
...
| `session status` | — | — | — | — |
| `extract (the sign-in screen, in place)` | `traces/11-extract--the-sign-in-screen--in-place.jsonl` | 2 | — | `hermes 1.0.0 (scripted agent)` |
...
Export requested 2026-09-18 14:26 UTC.
...
downloaded  conversations-000.zip  933.0 B
Claude extraction — rehearsal
...
Snapshot: /tmp/r5/store/claude/rehearsal/2026-09-18T14-26-52Z
```
...
Snapshot: /tmp/r5/store/claude/rehearsal/2026-09-18T14-26-52Z/skills
```
...
Snapshot: /tmp/r5/store/claude/rehearsal/2026-09-18T14-26-59Z/skills
```
...
Snapshot: /tmp/r5/store/claude/rehearsal/2026-09-18T14-27-02Z
```

```text
error: not logged in — run: dataporter --mock login --source claude --account rehearsal
```
...
| the second stamp sorts after the first | 2026-09-18T14-26-52Z < 2026-09-18T14-27-02Z | pass | *measured on 2026-09-18* |
...
| a sign-in screen at the export page is exit 3 and the remedy (`70`) | exit 3, the remedy is named | pass | *measured on 2026-09-18* |
| it never pressed anything: one trace, and no click in it (`70`) | 1 trace(s), 0 clicks | pass | *measured on 2026-09-18* |
| no session at all is exit 3 and no trace, because no browser opened (`69`) | exit 3, 0 traces | pass | *measured on 2026-09-18* |
...
| Step | Trace | Lines | Certificate | Agent |
| --- | --- | --- | --- | --- |
| `login` | `traces/01-login.jsonl` | 18 | — | `hermes 1.0.0 (scripted agent)` |
...
Export requested 2026-09-18 14:27 UTC.
...
Snapshot: /tmp/r5/store/chatgpt/rehearsal/2026-09-18T14-27-10Z
```
...
Snapshot: /tmp/r5/store/chatgpt/rehearsal/2026-09-18T14-27-12Z
```
...
| the mock minted one link per ask | 2 links listed, exports requested: 2 | pass | *measured on 2026-09-18* |
| both fetches file a complete snapshot | 2/2 fetches, 2 complete snapshots | pass | *measured on 2026-09-18* |
| the second stamp sorts after the first | 2026-09-18T14-27-10Z < 2026-09-18T14-27-12Z | pass | *measured on 2026-09-18* |
| ledger: conversations == chats created | [3, 3] == 3 (seeded 3) | pass | *measured on 2026-09-18* |
...
| the sign-in crossed to the auth origin | /log-in seen 9x | pass | *measured on 2026-09-18* |
